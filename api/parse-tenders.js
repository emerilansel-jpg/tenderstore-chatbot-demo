module.exports = async function handler(req, res) {
  ...
  const PROVIDERS = [
    { url: 'https://openrouter.ai/api/v1/chat/completions', model: 'google/gemini-2.0-flash-exp:free', key: process.env.OPENROUTER_API_KEY },
    { url: 'https://openrouter.ai/api/v1/chat/completions', model: 'qwen/qwen3-235b-a22b:free', key: process.env.OPENROUTER_API_KEY },
  ];
...
[
  {
    ...
    "kategori": "Salah satu dari: Drilling & Workover Well Service, Seismic Geotechnic & Geophysics, Computer & IT, Marine Transportation, Man Power General Labour Outsourcing"
  }
]
...
- Kategori HARUS salah satu dari 5 yang disebutkan, pilih yang paling cocok
...
- HANYA output JSON array, jangan ada text tambahan sebelum atau sesudah JSON`;
  ...
  return res.status(500).json({ error: 'Gagal memproses text. Coba lagi atau periksa format input.' });
};
