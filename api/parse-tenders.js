module.exports = async function handler(req, res) {
  ...
  const PROVIDERS = [
    ...
    { url: 'https://openrouter.ai/api/v1/chat/completions', model: 'google/gemma-4-26b-a4b-it:free', key: process.env.OPENROUTER_API_KEY },
    ...
    { url: 'https://openrouter.ai/api/v1/chat/completions', model: 'qwen/qwen3.6-plus:free', key: process.env.OPENROUTER_API_KEY },
  ];
