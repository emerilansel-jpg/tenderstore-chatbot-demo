                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                          await saveUsers(users, TOKEN);
                                                                                                                                                                                                                                return res.status(200).json({ success: true });
                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                        if (action === 'auth') {
                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                          const hash = crypto.createHash('sha256').update(password).digest('hex');
                                                                                                                                                                                                                                          const user = users.find(function(u) { return u.username === username && (u.passwordHash === hash || u.password === hash) && u.active; });
                                                                                                                                                                                                                                          return res.status(200).json({ success: !!user, name: user ? user.name : null });
                                                                                                                                                                                                                                        }
                                                                                                                                                                                                                                        if (action === 'delete') {
                                                                                                                                                                                                                                          const { username } = req.body;
                                                                                                                                                                                                                                          const idx = users.findIndex(function(x) { return x.username === username; });
